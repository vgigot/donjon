...
public class Bomb {
	...
	private boolean justLaid; // Si le joueur n'est pas sorti de la zone de la
								// bombe.

	private String effect; // N si bombe normale, D si bombe dangereuse, M si
							// bombe-taupe.
	...
	public void beginCountdown() {
		 ...
		 */
		bombThread = new ActionListener() { // Le compte a rebours pour
											// l'explosion.
			public void actionPerformed(ActionEvent e) {
				explode();
			}
		};
		time = new Timer(2000, bombThread);
		time.start();
	}
